...
Local build evidence (14 September 2026): both Wrangler dry runs succeed, with approximately 259 KiB production and 252 KiB feasibility gzip bundles. Native limiter enforcement is tested in Workerd. No live CPU, cold-start, KV-count or global revocation measurement is claimed.
